function SettingIcon() {
  return (
    <div>
      <svg
        className="w-5 h-5 text-white transition duration-75 dark:text-white group-hover:text-gray-900 dark:group-hover:text-gray-300"
        aria-hidden="true"
