...
const Groupcontact: React.FC = () => {
  ...
  return (
    <div
      className="p-6 bg-white rounded-lg shadow-xl w-full h-screen flex justify-center align-middle items-center"
      style={{
    ...
    >
      <div className="w-[750px] border border-cyan-400 p-8 rounded-lg bg-gray-50 ">
